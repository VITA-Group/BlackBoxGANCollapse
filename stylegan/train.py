...
desc += '-celebahq'; dataset = EasyDict(tfrecord_dir='celebahq', resolution=128);             train.mirror_augment = True
...
def main():
    ...
    if args.attribute.lower() == 'age':
        ...
        dataset.tfrecord_dir = 'celebahq-ffhq-cbd-race'
    elif args.attribute.lower() == 'identity':
        dataset.tfrecord_dir = 'celebahq-identity'
    else:
        dataset.tfrecord_dir = 'celebahq_tfrecords'
