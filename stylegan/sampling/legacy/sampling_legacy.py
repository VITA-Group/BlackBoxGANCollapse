...
def monte_carlo_sampling(Gs, start, end, save_dir):
    ...
    for i in range(start, end, batch_size):
        ...
        # _, genders = eval_age_gender(sess_age_gender, images_160, batch_size, age_op, gender_op, images_ph_age_gender)
        # age_lst.extend(ages)
        # gender_lst.extend(genders)
...
def main():
    ...
    #monte_carlo_sampling(load_Gs('../cache/263e666dc20e26dcbfa514733c1d1f81_karras2019stylegan-ffhq-1024x1024.pkl'), args.start, args.end, args.save_dir)
    # monte_carlo_sampling(load_Gs(args.model_dir), args.start, args.end, args.save_dir)
    monte_carlo_sampling(load_Gs('../pretrained_models/karras2019stylegan-ffhq-1024x1024.pkl'), args.start, args.end, args.save_dir)
