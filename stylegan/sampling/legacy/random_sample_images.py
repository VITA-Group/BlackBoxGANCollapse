...
def load_Gs(model_path):
    ...
    pkl = 'network-snapshot-012000.pkl'
...
def random_sampling(Gs, start, end, id):
    save_dir = 'monte_carlo_sampling_10k'
...
def main():
    ...
    tflib.init_tf()
    random_sampling(load_Gs('../results/00006-sgan-celebahq-4gpu_race_128'), args.start, args.end, args.resolution)
#----------------------------------------------------------------------------
