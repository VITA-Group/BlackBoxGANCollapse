...
if 1:
    ...
    desc += '-celebahq'; dataset = EasyDict(tfrecord_dir='celebahq', resolution=1024);             train.mirror_augment = True
    ...
    #desc += '-2gpu'; submit_config.num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4, 1024: 4}
    #desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16}
    desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4, 1024: 4}
...
def main():
    parser = argparse.ArgumentParser(description='Parameters for training stylegan')
    parser.add_argument('--attribute', required=True, help='The fairness attribute to investigate', type=str)
    parser.add_argument('--resolution', required=True, help='Target output resolution', type=int)
    args, other_args = parser.parse_known_args()
    if args.attribute.lower() == 'age':
        dataset.tfrecord_dir = 'celebahq-age'
    elif args.attribute.lower() == 'gender':
        dataset.tfrecord_dir = 'celebahq-gender'
    elif args.attribute.lower() == 'race':
        dataset.tfrecord_dir = 'celebahq-race'
    elif args.attribute.lower() == 'identity':
        dataset.tfrecord_dir = 'celebahq-identity'
    else:
        dataset.tfrecord_dir = 'celebahq'

    dataset.resolution = args.resolution

    print('Training on fairness attribute of {}, resolution at {}, tfrecord_dir at {}'.format(args.attribute.lower(), dataset.resolution, dataset.tfrecord_dir))
    ...
    kwargs.submit_config.run_desc = '{}_{}_{}'.format(desc, args.attribute.lower(), args.resolution)
