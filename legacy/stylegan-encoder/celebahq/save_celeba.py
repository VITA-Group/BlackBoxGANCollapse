...
def create_celebahq_resized(save_dir, celeba_dir, delta_dir, start, end, num_threads=4, num_tasks=100):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--start', help='Directory with images for encoding', type=int)
    parser.add_argument('--end', help='Directory for storing generated images', type=int)
    args, other_args = parser.parse_known_args()
    save_dir = 'celebahq/img_resized'
    celeba_dir = 'celebahq'
    delta_dir = 'celebahq/celeba-hq-deltas'
    create_celebahq_resized(save_dir, celeba_dir, delta_dir, args.start, args.end, num_threads=4, num_tasks=100)