...
def plot_distribution(save_path, final_neighbors_count_lstoflst, epsilon):
    # %matplotlib inline
    ...
    plt.hist([final_neighbors_count_lstoflst[9]], normed=True, histtype='step', cumulative=True, bins=bins, color=['r'], label=['100000'])
...
if __name__ == "__main__":
    ...
    for epsilon in list(pl.frange(args.start, args.end, args.step_size)):
        ...
        plot_distribution(os.path.join(path, 'neighbors'), final_neighbors_count_lstoflst, epsilon)