    ...
    for epsilon in list(pl.frange(args.start, args.end, args.step_size)):
        ...
        for ind in indices:
            ...
            for index, _ in pair_lst:
                latents_dir = os.path.join('latents', '{}_{}'.format((index // 1000000) * 1000000, (index // 1000000 + 1) * 1000000))
                ...
                latents = np.load(src)
                np.save(dst, latents[index % 10000])
                i += 1

            # cluster
            latents_dir = os.path.join('latents', '{}_{}'.format((ind // 1000000) * 1000000, (ind // 1000000 + 1) * 1000000))
            #latents_dir = os.path.join('latents', '0_1000000')
